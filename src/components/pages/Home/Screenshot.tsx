...
export const HomeScreenshot = ({ active }) => {
  return (
    <section
      id="screenshotHome"
      className={clsx(
        'group flex min-h-[calc(100vh-80px)] flex-row justify-center  bg-[#111]  transition-all duration-1000 ',
        {
          'gap-48': active === 'screenshotHome',
          'gap-32': active !== 'screenshotHome',
        }
      )}
    >
      <div className="flex  flex-col items-start justify-center gap-y-[5.925rem]    ">
          ...
          <div className="pt-3">
            ...
            <ul>
              <li className="text-justify indent-2 font-light ">
                ...
                Linguagem super versatil, simples e aplicavel no Front-end e no
                Back-end.
              </li>
              <li className=" text-justify indent-2 font-light ">
        ...
        <div className="flex w-[621px] max-w-[621px] gap-3">
          ...
          <div className="pt-3">
            ...
            <p className=" mt-5 text-justify font-light ">
              Comparado com outras profissoes, um desenvolvedor tem a capacidade
              de lucrar com diversos tipos de servicos e em areas diferentes.
            </p>
            <ul>
              ...
              <p className=" mt-0 text-justify font-medium ">Algumas areas:</p>
              <li className=" text-justify indent-2 font-medium ">
